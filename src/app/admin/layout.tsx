        ...
        <header className="h-16 bg-white dark:bg-background/50 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 z-10 shrink-0">
          <div className="flex items-center gap-4 flex-1">
            ...
            <div className="relative max-w-md w-full hidden md:block">
              ...
              <input
                ...
                placeholder="Search orders, products, quotes..."
                type="text"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button className="p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl relative transition-colors">
              ...
              <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-primary rounded-full border-2 border-white dark:border-background" />
            </button>
            ...
            <div className="hidden sm:flex flex-col items-end mr-2">
              <span className="text-xs font-bold text-secondary dark:text-slate-200 leading-tight capitalize">
                {profile.role}
              </span>
